        ...
        <div class="novo-projeto" align="left">
            <div class="form" align="center">
                ...
                <form:form id="editar" commandName="projeto" servletRelativeAction="${url }" enctype="multipart/form-data" cssClass="form-horizontal" method="POST">
                    ...
                    <c:forEach items="${projeto.participantes}" var="participante">
                        <label for="cargaHoraria" class="col-sm-2 control-label">Carga
                            Horária ${participante.pessoa.nome}:</label>
                        <div class="col-sm-2">
                            <input name="cargaParticipante" id="cargaHoraria" type="number" min="1"
                    ...
                    <c:forEach items="${projeto.participantes}" var="participante">
                        <label for="cargaHoraria" class="col-sm-2 control-label">Carga
                            Horária ${participante.pessoa.nome}:</label>
                        <div class="col-sm-2">
                            <input name="valorBolsaParticipante" id="valorBolsa" type="number" min="1"
                                placeholder="1"  class="form-control" />
                            <div class="error-validation">
                                <form:errors path="cargaHoraria"></form:errors>
                            </div>
